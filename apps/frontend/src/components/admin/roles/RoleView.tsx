...
import { ArrowLeft, Users, AlertCircle, Plus } from 'lucide-react'
          ...
          <CardContent>
            <div className='overflow-x-auto'>
              {/* <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead className='font-semibold text-[#2C2C2C]'>Nombre</TableHead>
                    <TableHead className='font-semibold text-[#2C2C2C]'>Descripción</TableHead>
                    <TableHead className='font-semibold text-[#2C2C2C]'>Estado</TableHead>
                    <TableHead className='font-semibold text-[#2C2C2C]'>Fecha Creación</TableHead>
                    <TableHead className='font-semibold text-[#2C2C2C]'>Acciones</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {roles.map((role) => (
                    <TableRow key={role.id}>
                      ...
                      <TableCell className='text-gray-600 max-w-xs truncate'>{role.description}</TableCell>
                      <TableCell>
                        <Badge
                          variant={role.isActive ? 'default' : 'secondary'}
                          className={
                            role.isActive
                              ? 'bg-[#00B179]/10 text-[#00B179] hover:bg-[#00B179]/20 cursor-pointer'
